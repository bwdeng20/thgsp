...
def draw_signal(
    ...
    **kwargs
    ...
    signal: Tensor, List, Tuple
            A :obj:`(N,)` tensor carrying signals. `:obj:`signal[i]` is the value of
            graph signal at the i-th vertex.
    pos:    Tensor, optional
            :obj:`(N,D)`  N is the number of nodes, and D is the dimension of node
            coordinates. If :py:obj:`None`, the positions generated by
            :py:func:`networkx.spring_layout` will be used.
    ...
    with_labels:bool
            If True, the node ordinal will be annotated in the circle unless there are
            more than 4000 nodes. If False, the node ordinal will not be drawn.
